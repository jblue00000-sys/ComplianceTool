        ...
        <div className="border-t border-(--color-line) bg-[#0c1220] px-4 py-3.5">
          ...
          {detail && hasAssessments(id) && DETAIL_TAB[id] ? (
            ...
            <p className="mt-3.5 text-[12.3px] text-(--color-dim)">
              The {detail.controls.length} controls the standard asks for are transcribed. No
              agent has been assessed against them yet, so this score is a declared posture
              rather than a roll-up of those controls.
            </p>
          ) : (
            <p className="mt-3.5 text-[12.3px] text-(--color-dim)">
