...
| `fm-context-index`       | Index and semantically search this home's transcripts, records, briefs, reports, and status history in its own local vector store ([context-index.md](context-index.md)) |
