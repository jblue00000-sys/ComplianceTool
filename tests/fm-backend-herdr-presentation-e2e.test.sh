...
for ROUND in 1 2 3; do
  ...
  printf '%s\n' '# Definition of done' >> "$HOME_DIR/data/focus-$ROUND-a/brief.md"
  printf 'Projection focus wave %s fixture B.\n' "$ROUND" > "$HOME_DIR/data/focus-$ROUND-b/brief.md"
  printf '%s\n' '# Definition of done' >> "$HOME_DIR/data/focus-$ROUND-b/brief.md"
...
printf '%s\n' '# Definition of done' >> "$HOME_DIR/data/pcw/brief.md"
printf 'Cross-home concurrent A.\n' > "$SECOND_HOME_A/data/acw/brief.md"
printf '%s\n' '# Definition of done' >> "$SECOND_HOME_A/data/acw/brief.md"
printf 'Cross-home concurrent B.\n' > "$SECOND_HOME_B/data/bcw/brief.md"
printf '%s\n' '# Definition of done' >> "$SECOND_HOME_B/data/bcw/brief.md"
...
printf '%s\n' '# Definition of done' >> "$SECOND_HOME_A/data/aflat/brief.md"
if FM_SPAWN_HERDR_PRESENTATION_LOCK_ATTEMPTS=$PRESENTATION_LOCK_ATTEMPTS_CONTENDED \
...
printf '%s\n' '# Definition of done' >> "$SECOND_HOME_A/data/$CROSS_RESTART_ID/brief.md"
...
printf '%s\n' '# Definition of done' >> "$HOME_DIR/data/$PRIMARY_WAVE_ID/brief.md"
printf 'Concurrent secondmate recovery fixture.\n' > "$SECOND_HOME_B/data/$BRAVO_WAVE_ID/brief.md"
printf '%s\n' '# Definition of done' >> "$SECOND_HOME_B/data/$BRAVO_WAVE_ID/brief.md"
...
printf '%s\n' '# Definition of done' >> "$HOME_DIR/data/post-legacy/brief.md"
