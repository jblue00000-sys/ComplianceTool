...
- [docs/context-index.md](docs/context-index.md) - set up and run the local, machine-only semantic index over one home's transcripts, records, briefs, reports, and status history.
